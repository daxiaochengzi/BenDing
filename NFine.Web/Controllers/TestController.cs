...
/// </summary>
    public class TestController : ApiController
    {
        ...
        /// <returns></returns>
        [HttpGet]
        public ApiJsonResultData HisTest([FromUri]BaseUiBusinessIdDataParam param)
        {
            return new ApiJsonResultData(ModelState, new UiInIParam()).RunWithTry(y =>
            {
                // y.DataDescribe = CommonHelp.GetPropertyAliasDict(new UiInIParam());
               HisSettlement(param); 
        ...
        /// <param name="param"></param>
        [NonAction]
        private void HisSettlement(BaseUiBusinessIdDataParam param)
        {
